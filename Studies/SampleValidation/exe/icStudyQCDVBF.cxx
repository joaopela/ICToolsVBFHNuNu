...
int main(int argc, char *argv[]){
  ...
  evQCDVBF["QCD_VBF-Pt-80to120"]  = 39376000000;
  evQCDVBF["QCD_VBF-Pt-120to170"] = 7000000000;
  evQCDVBF["QCD_VBF-Pt-170to300"] = 1375000000;
  evQCDVBF["QCD_VBF-Pt-300to470"] = 80000000;
  evQCDVBF["QCD_VBF-Pt-470to600"] = 25000000;
  ...
  wgt["QCD-Pt-30to50"]     = (evQCDInc["QCD-Pt-30to50"]    *xsec["QCD-Pt-30to50"])    /lumi;
  wgt["QCD-Pt-50to80"]     = (evQCDInc["QCD-Pt-50to80"]    *xsec["QCD-Pt-50to80"])    /lumi;
  wgt["QCD-Pt-80to120"]    = (evQCDInc["QCD-Pt-80to120"]   *xsec["QCD-Pt-80to120"])   /lumi;
  wgt["QCD-Pt-120to170"]   = (evQCDInc["QCD-Pt-120to170"]  *xsec["QCD-Pt-120to170"])  /lumi;
  wgt["QCD-Pt-170to300"]   = (evQCDInc["QCD-Pt-170to300"]  *xsec["QCD-Pt-170to300"])  /lumi;
  wgt["QCD-Pt-300to470"]   = (evQCDInc["QCD-Pt-300to470"]  *xsec["QCD-Pt-300to470"])  /lumi;
  wgt["QCD-Pt-470to600"]   = (evQCDInc["QCD-Pt-470to600"]  *xsec["QCD-Pt-470to600"])  /lumi;
  wgt["QCD-Pt-600to800"]   = (evQCDInc["QCD-Pt-600to800"]  *xsec["QCD-Pt-600to800"])  /lumi;
  wgt["QCD-Pt-800to1000"]  = (evQCDInc["QCD-Pt-800to1000"] *xsec["QCD-Pt-800to1000"]) /lumi;
  wgt["QCD-Pt-1000to1400"] = (evQCDInc["QCD-Pt-1000to1400"]*xsec["QCD-Pt-1000to1400"])/lumi;
  wgt["QCD-Pt-1400to1800"] = (evQCDInc["QCD-Pt-1400to1800"]*xsec["QCD-Pt-1400to1800"])/lumi;
  wgt["QCD-Pt-1800"]       = (evQCDInc["QCD-Pt-1800"]      *xsec["QCD-Pt-1800"])      /lumi;

  wgt["QCD_VBF-Pt-80to120"]  = (evQCDInc["QCD_VBF-Pt-80to120"] *xsec["QCD-Pt-80to120"]) /lumi;
  wgt["QCD_VBF-Pt-120to170"] = (evQCDInc["QCD_VBF-Pt-120to170"]*xsec["QCD-Pt-120to170"])/lumi;
  wgt["QCD_VBF-Pt-170to300"] = (evQCDInc["QCD_VBF-Pt-170to300"]*xsec["QCD-Pt-170to300"])/lumi;
  wgt["QCD_VBF-Pt-300to470"] = (evQCDInc["QCD_VBF-Pt-300to470"]*xsec["QCD-Pt-300to470"])/lumi;
  wgt["QCD_VBF-Pt-470to600"] = (evQCDInc["QCD_VBF-Pt-470to600"]*xsec["QCD-Pt-470to600"])/lumi;
  
  //_________________________________________  
  ICLatexTabular tabXSec(19,3);
...
//     tabXSec.set(int(i+1),0,samples[i]);//samples[i]);  
//     tabXSec.set(int(i+1),1,"");//xsec[(*s)]);
//     tabXSec.set(int(i+1),2,"");//wgt [(*s)]);
  }
...
//   tabXSec.setRowDecorationAfter (18,"\\hline");
...
//   tabXSec.saveAs("table_xSec.tex");
  ...
  for(map<string,TFile*>::iterator f=files.begin(); f!=files.end(); f++){
    ...
    double intWgt   = integral*wgt[f->first];
    
    printf("%20s : %8.0f : %10.2f : %10.2f\n",(f->first).c_str(),entries,integral,intWgt);
